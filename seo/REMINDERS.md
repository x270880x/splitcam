...
|---|---|---|
| **вт 2026-09-09** | `/alternatives/snap-camera/` | через 4 недели: показы по кластеру snap camera (было 22 за 90 дней), позиция, клики |
| **вт 2026-09-16** | `/alternatives/nvidia-broadcast/` | через 4 недели: кластер nvidia broadcast (было 29 за 90 дней) |
