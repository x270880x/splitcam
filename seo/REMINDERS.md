...
| — | ⏳ открыто | **Заявка в Malwarebytes на перепроверку домена** — подать вручную: их форум и справка закрыты бот-защитой Cloudflare, постинг требует аккаунта. Готовый текст и ссылки: `seo/MALWAREBYTES-FP.md` |
