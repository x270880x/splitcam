...
| — | ⏳ открыто | **Снять блокировки домена у 5 вендоров** — splitcam.com помечен как вредоносный: AlphaSOC, CRDF, Fortinet, MalwareURL (категория `Trojan JS ClearFake`), Gridinsoft. Живого заражения не найдено, флаг доменного уровня. План, тексты заявок и порядок: `seo/REPUTATION-DELISTING.md`. Все шесть заявок подаются человеком — везде CAPTCHA или аккаунт |
