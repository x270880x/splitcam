...
| — | 🔄 в работе | **Снять блокировки домена** — на 12.08 счётчик VirusTotal упал с 4/91 до 2/91: AlphaSOC снят, CRDF оказался не листингом вовсе. Держатся Fortinet (заявка подана) и MalwareURL (письмо отправлено), Gridinsoft — тикет подан 12.08, владение подтверждено. Отдельно жива запись ThreatFox IOC 1861022, нужен аккаунт abuse.ch. Статусы: `seo/APPEALS-READY.md` |
