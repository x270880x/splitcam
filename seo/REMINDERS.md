...
| 🔴 срочно | ⏳ открыто | **Переезд 18.09 — хвосты** (`seo/MIGRATION-2026-09-18.md`): ответить HostPro (DNS сделали сами; дата остановки da3?); после остановки da3 убрать `ip4:77.83.100.153` из SPF; проверить `splitstream.com` (токену не виден); решить про `images.xml` — программа просит 9 тыс. раз/сут, отдаём 404 |
