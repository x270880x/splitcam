# SEO Reminders — журнал (архив)

> 🔴 **Все адреса серверов в этом файле — история, а не текущее состояние.**
> На 2026-08-12 веб и почта живут на `77.83.100.153` (панель `pl-rocket-da3`).
> Записи ниже про `185.67.3.44`, `rocket-da4`, `91.223.223.113` и `77.83.100.124`
> верны на свою дату и намеренно не переписаны — это летопись переездов.
> Действующее — в [REMINDERS.md](REMINDERS.md), раздел «ДЕЙСТВУЮЩАЯ ИНФРАСТРУКТУРА».
>
> История завершённых работ по splitcam.com. Вынесено из `REMINDERS.md`
> 2026-07-19: рабочий файл разросся до 714 строк, и шесть постоянных правил
> терялись между отчётами о закрытых задачах.
>
> **Действующие правила и живые задачи — в [REMINDERS.md](REMINDERS.md).**
> Здесь только то, что завершено. Операционные детали (доступы, действующая
> конфигурация почты, регулярные процедуры) подняты в рабочий файл.
...
## Panel migration cPanel → DirectAdmin — СНЯТО С ПОВЕСТКИ (2026-07-19)

> Планировалось на ~2026-08-01. Снято по решению пользователя 2026-07-19 как
> неактуальное. Чек-лист сохранён: он зеркалит переезд 2026-07-02 и пригодится,
> если к вопросу вернутся. Напомним: WEB уже на DirectAdmin с 2026-07-06,
> на cPanel остаётся только почта.
