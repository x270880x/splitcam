...
Долг на момент записи: такую вычитку прошёл только раздел /alternatives/ (2026-09-04).
Добавлен `/alternatives/vmix/` — вычитан носителями 2026-09-05 (карточка iOS/Android в 34
локалях + переписанные под бюджет CJK-мета).
НЕ прошли: /phone-as-webcam/, /multi-camera/, раздел про плагин на /stream-deck/, замена
«peer-to-peer» в 9 страницах × 34, правки ключей в 7 парах, ссылки на хабах. Это следующий проход.
